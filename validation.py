...
# TODO: Agentの抽象化の方針が決まったらちゃんとenvとagentで書き直す

# testはこの行が違うだけ
logging.basicConfig(filename='log/dpg_pn/valid.log', level=logging.INFO)
...
num = sys.argv[1]
policy.load_state_dict(torch.load('exp/dpg_pn/p' + num + '.model'))
