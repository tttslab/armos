...
import numpy as np
import dpg_pn.models as models
import env.utils as utils
import configparser
import dpg_pn.TractSeqToWave_File as TractSeqToWave_File
import librosa
import sys
...
with torch.no_grad():
    ...
    TractSeqToWave_File.vtlSynthesize(t_param[0].flatten().tolist(), g_param[0].flatten().tolist(), dur[0]+frameRate_Hz/1000.0)
