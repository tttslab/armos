...
class stacked_BLSTM(nn.Module):
    def __init__(self, in_size, out_size, hidden_size, num_layers):
        ...
        self.mean    = nn.Linear(hidden_size*2, out_size)
        self.logvar  = nn.Linear(hidden_size*2, out_size)
    ...
    def forward(self, inputs, length):
        ...
        return self.sigmoid(self.mean(blstm_out)), self.sigmoid(self.logvar(blstm_out))+1e-20
